...
def ht_adj_( dyn_in_prm, dyn_in_val, dyn_in_val2, CONVECT, CONV_CRIT,
    ...
    if ( eqv_neut_prm == 0 ):
        ...
        zo_mag =  pass_by_ref_params['zo_m'][0] # test option
        ...
        # zzt = z_wanted * z_o_zt( ref_ht_wind, ref_ht_tq, nu, zo_mag, Stanton )
        #    / ref_ht_tq;
        #    zzq = z_wanted * z_o_zq( ref_ht_wind, ref_ht_tq, nu, zo_mag, Dalton ) /
        #    ref_ht_tq;
